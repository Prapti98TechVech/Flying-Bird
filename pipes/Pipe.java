...
public class Pipe {
    ...
    private final float DISTANCE_BETWEEN_PIPES=400f;
    private OrthographicCamera mainCamera;

    private Random random=new Random();

    public Pipe(World world, float x){
        this.world=world;
    ...
    public void movePipes(){
        body1.setLinearVelocity( (float)-1.3,0);
        body2.setLinearVelocity( (float)-1.3,0);
        body3.setLinearVelocity( (float)-1.3,0);
